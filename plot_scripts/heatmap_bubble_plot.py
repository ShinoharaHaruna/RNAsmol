...
dendrogram_col = hierarchy.dendrogram(
    hierarchy.linkage(data_matrix, method="average"), no_plot=True
)
...
col = PatchCollection(
    circles, array=data_matrix.T.flatten(), cmap="PuOr", alpha=0.5, norm=norm
)
