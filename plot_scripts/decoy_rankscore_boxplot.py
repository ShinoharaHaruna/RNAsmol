...
df = pd.DataFrame(
    {
        "RNAmigos": RNAmigos_tenfold_eu_ranklst,
        "RNAmigos2": RNAmigos2_tenfold_mixed_ranklst,
        "rDock": rdock_tenfold_ranklst,
        "RNAsmol": RNAsmol_tenfold_ranklst,
    }
)

colors = ["#8098BB", "#9DC4A9", "#D88CAF", "#A99DC4"]
ax = sns.boxplot(data=df, palette=colors, fliersize=0, boxprops=dict(alpha=0.6))
